...
public class SlotMachineFrame extends JFrame{
	...
	public void frmStats() {
		...
		saveT.addActionListener(new ActionListener() { // Activated once the User selects "save tiles"
			...
			ObjectWriter<Tiles> ow = new ObjectWriter<Tiles>(); // Responsible for writing the current tiles into an external file
			public void actionPerformed(ActionEvent e) {
				if(jfc.showSaveDialog(null)== JFileChooser.APPROVE_OPTION){ 
					if(ow.write(jfc.getSelectedFile(),panCenter.getTiles() )) { // Opens the prompt for the user to save their file
